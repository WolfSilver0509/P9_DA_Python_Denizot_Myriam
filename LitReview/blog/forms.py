...
class Ticket_Form(ModelForm, ImageField):
    class Meta:
        ...
        widgets = {
            "title": TextInput(
                attrs={"placeholder": "Titre du livre", "class": "form-title"}
            ),
            "description": Textarea(
                attrs={"placeholder": "Description du ticket", "class": "form-desc"}
            ),
        }
...
class Critique_Form(ModelForm):
    class Meta:
        ...
        widgets = {
            "headline": TextInput(
                attrs={"placeholder": "Titre", "class": "form-title"}
            ),
            "body": Textarea(
                attrs={
...
class Follow_Form(forms.Form):
    username = forms.CharField(
        label="", widget=TextInput({"placeholder": "Username", "class": "form-title"})
    )
